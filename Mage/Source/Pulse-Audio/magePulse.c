...
static void magePulseAudioCallback(pa_context *context, void *userData)
{

}

mageResult mageAudioDriverCreate(struct mageAudioDriver *driver)
{
    ...
    pa_context_set_state_callback(driver->Context, magePulseAudioCallback, driver);
